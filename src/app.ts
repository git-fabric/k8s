...
export function createApp(adapterOverride?: K8sAdapter): FabricApp {
  ...
  const tools: FabricTool[] = [
...

    {
      ...
      execute: async (a) => k8s.listPods(a.namespace as string | undefined),
    },
    {
      name: 'k8s_get_pod',
      ...
      execute: async (a) => k8s.getPod(a.namespace as string, a.name as string),
    },
    {
      ...
      execute: async (a) => ({
        logs: await k8s.getPodLogs(a.namespace as string, a.name as string, {
          container: a.container as string | undefined,
          tailLines: a.tailLines as number | undefined,
          sinceSeconds: a.sinceSeconds as number | undefined,
    ...
    },
    {
      ...
      execute: async (a) => k8s.getPodProblems(a.namespace as string | undefined),
    },
...

    {
      ...
      execute: async (a) => k8s.listDeployments(a.namespace as string | undefined),
    },
    {
      ...
      execute: async (a) => k8s.getDeployment(a.namespace as string, a.name as string),
    },
...

    {
      ...
      execute: async (a) => k8s.listServices(a.namespace as string | undefined),
    },
    ...
    },
    {
      ...
      execute: async (a) => k8s.getNode(a.name as string),
    },
...

    {
      ...
      execute: async (a) => k8s.listEvents(
...

    {
      ...
      execute: async (a) => k8s.listPVCs(a.namespace as string | undefined),
    },
...

    {
      ...
      execute: async (a) => k8s.listCronJobs(a.namespace as string | undefined),
    },
    {
      name: 'k8s_list_jobs',
      ...
      execute: async (a) => k8s.listJobs(a.namespace as string | undefined),
    },
...

    {
      ...
      execute: async (a) => k8s.listIngressRoutes(a.namespace as string | undefined),
    },
    ...
    },
    {
      ...
      execute: async (a) => k8s.getArgoCDApp(a.name as string),
    },
...

    {
      ...
      execute: async (a) => k8s.listScaledObjects(a.namespace as string | undefined),
    },
